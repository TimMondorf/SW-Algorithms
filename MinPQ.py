    ...
    def del_min(self):
        ...
        if self.N == 1:
            ...
            #        print('value of right child ' + str(self.array[right_child_index]))
                    ...
                    if self.array[sinking_key_index] > min(self.array[left_child_index], self.array[right_child_index]):
...
while not tim_MinPQ.is_empty():

    print(str(tim_MinPQ.show_self_N()) + ' ' + str(tim_MinPQ.del_min()) ) 
